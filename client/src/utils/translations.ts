...
export const translations = {
  en: {
    ...
    textChat: 'Text Chat',
    callModeActive: 'Call Mode Active',
    callModeDescription: 'Voice input and hands-free mode will be automatically enabled. You can speak naturally with the AI client just like a real phone call.',
    ...
    enterTeamDescription: 'Enter team description (optional)',
    whatHappensNext: 'What happens next?',
    teamWillBeCreated: 'Team will be created and ready for members',
    canAssignTeamLeader: 'You can assign a team leader to this team',
    teamMembersCanBeAdded: 'Team members can be added from the Users tab',
    teamSettingsCanBeManaged: 'Team settings can be managed later',
    ...
    confirmPassword: 'Confirm Password',
    passwordsDoNotMatch: 'Passwords do not match',
    enterPasswordMin: 'Enter password (min 8 characters)',
    ...
    selectTheTeamThisUserWillLead: 'Select the team this user will lead',
    optionallyAssignThisUserToTeam: 'Optionally assign this user to a team',
    noTeamsAvailableCreateFirst: 'No teams available. Create a team first before assigning a team leader.',
    pleaseSelectATeamForTeamLeader: 'Please select a team for team leader role',
    authenticationTokenNotFound: 'Authentication token not found. Please log in again.',
    error: 'Error',
    ...
    custom: 'Custom',
    customizableLimit: 'Customizable limit',
    unlimitedConversations: 'Unlimited conversations',
    conversationsPerMonth: 'conversations/month',
    aiTipsPerMonth: 'AI Tips per month',
    voiceConversationsAndCalls: 'Voice conversations and calls',
    ...
    // Pricing Features
    freeConversations: '3 AI conversations per month',
    basicConversations: '30 AI conversations per month',
    proConversations: '50 AI conversations per month',
    unlimitedConversations: '200 AI conversations per month',
    enterpriseConversations: 'Customizable AI conversations per day',
    basicAiTips: '10 AI Tips per month',
    proAiTips: '25 AI Tips per month',
    unlimitedAiTips: '50 AI Tips per month',
    enterpriseAiTips: 'Customizable AI Tips limit',
    basicFeatures: 'Basic sales scenarios',
  ...
  et: {
    ...
    forgotPasswordSubtitle: 'Ära muretse, saadame sulle lähtestamise juhised.',
    sendResetInstructions: 'Saada lähtestamise juhised',
    sending: 'Saadetakse...',
    checkYourEmail: 'Kontrolli oma e-posti',
    backToLogin: 'Tagasi sisselogimisele',
    rememberPassword: 'Mäletad parooli? Logi sisse',
    enterEmailAddress: 'Sisesta oma e-posti aadress',
    ...
    voiceCall: 'Häälkõne',
    textChat: 'Tekstivestlus',
    callModeActive: 'Kõnerežiim Aktiivne',
    callModeDescription: 'Häälsisend ja vabakäe režiim lülitatakse automaatselt sisse. Saad AI kliendiga loomulikult rääkida nagu päris telefonikõne.',
    ...
    enterFirstName: 'Sisesta eesnimi',
    enterLastName: 'Sisesta perekonnanimi',
    enterEmail: 'Sisesta e-posti aadress',
    enterPassword: 'Sisesta parool',
    selectRole: 'Vali roll',
    selectTeam: 'Vali meeskond (valikuline)',
    addingUser: 'Kasutaja lisamine...',
    updateUser: 'Uuenda Kasutajat',
    updatingUser: 'Kasutaja uuendamine...',
    userRole: 'Kasutaja Roll',
    teamAssignment: 'Meeskonna Määramine',
    emailAddress: 'E-posti Aadress',
    passwordsDoNotMatch: 'Paroolid ei ühti',
    enterPasswordMin: 'Sisesta parool (vähemalt 8 tähemärki)',
    confirmPasswordPlaceholder: 'Kinnita parool',
    firstName: 'Eesnimi',
    lastName: 'Perekonnanimi',
    role: 'Roll',
    companyUser: 'Ettevõtte Kasutaja',
    selectATeam: 'Vali meeskond',
    noTeamAssigned: 'Meeskonda pole määratud',
    selectTheTeamThisUserWillLead: 'Vali meeskond, mida see kasutaja juhib',
    optionallyAssignThisUserToTeam: 'Määra see kasutaja meeskonda (valikuline)',
    noTeamsAvailableCreateFirst: 'Meeskondi pole saadaval. Loo esmalt meeskond enne meeskonnajuhi määramist.',
    pleaseSelectATeamForTeamLeader: 'Palun vali meeskond meeskonnajuhi rolli jaoks',
    authenticationTokenNotFound: 'Autentimise märk puudub. Palun logi uuesti sisse.',
    error: 'Viga',
    ...
    faqQuestion7: 'Milliseid keeli SalesBuddy toetab?',
    faqAnswer7: 'SalesBuddy toetab praegu inglise, eesti, hispaania ja vene keelt. Plaanime tulevikus lisada rohkem keeli kasutajate nõudluse alusel.',
    faqQuestion8: 'Kui täpne on AI tagasiside?',
    faqAnswer8: 'Meie AI pakub väga täpset tagasisidet, mis põhineb tõestatud müügimeetoditel. Süsteem hindab teie jõudlust peamistel müügi etappidel ja pakub teostatavaid ülevaateid, mis aitavad teil parandada.',
    faqQuestion9: 'Kas saan oma vestluste andmeid eksportida?',
    faqAnswer9: 'Jah, kasutajad saavad eksportida oma vestluste ajalugu ja jõudluse analüütikat. See funktsioon on saadaval kõigis tasulistes plaanides ja aitab teil jälgida oma edusammu aja jooksul.',
    faqQuestion10: 'Kas minu andmed on turvalised ja privaatsed?',
    faqAnswer10: 'Absoluutselt. Kasutame ettevõtte tasemel turvameetmeid teie andmete kaitsmiseks. Kõik vestlused on krüpteeritud liikumise ja puhkeoleku ajal ning me ei jaga kunagi teie isikuandmeid kolmandate osapooltega.',
    faqQuestion11: 'Mis juhtub, kui tühistan oma tellimuse?',
    faqAnswer11: 'Saate jätkata oma konto kasutamist kuni praeguse arveldusperioodi lõpuni. Pärast tühistamist kaotate juurdepääsu premium funktsioonidele, kuid saate neid igal ajal uuesti aktiveerida.',
    faqQuestion12: 'Kas pakute mahukaid allahindlusi suurtele meeskondadele?',
    faqAnswer12: 'Jah, pakume kohandatud hinnakujundust ettevõtte meeskondadele, kus on 50+ kasutajat. Võtke ühendust meie müügimeeskonnaga aadressil RevoTechSB@gmail.com, et arutada mahukaid allahindlusi ja kohandatud funktsioone.',
  ...
  es: {
    ...
    forgotPasswordSubtitle: 'No te preocupes, te enviaremos instrucciones para restablecer.',
    ...
    callModeActive: 'Modo de Llamada Activo',
    callModeDescription: 'La entrada de voz y el modo manos libres se habilitarán automáticamente. Puedes hablar naturalmente con el cliente AI como en una llamada telefónica real.',
    ...
    customizableLimit: 'Límite personalizable',
    unlimitedConversations: 'Conversaciones ilimitadas',
    conversationsPerMonth: 'conversaciones/mes',
    aiTipsPerMonth: 'Consejos de IA por mes',
    voiceConversationsAndCalls: 'Conversaciones de voz y llamadas',
    prioritySupport: 'Soporte prioritario',
    advancedTeamManagement: 'Gestión avanzada de equipos',
    companyLeaderboards: 'Tablas de clasificación de la empresa',
    ssoIntegration: 'Integración SSO',
    customBranding: 'Marca personalizada',
    advancedAnalyticsDashboard: 'Panel de análisis avanzado',
    apiAccess: 'Acceso API',
    dedicatedAccountManager: 'Gerente de cuenta dedicado',
    priorityPhoneSupport: 'Soporte telefónico prioritario',
    customTrainingPrograms: 'Programas de capacitación personalizados',
    whiteLabelSolutions: 'Soluciones de marca blanca',
    ...
    // Pricing Features
    freeConversations: '3 conversaciones de IA por mes',
    basicConversations: '30 conversaciones de IA por mes',
    proConversations: '50 conversaciones de IA por mes',
    unlimitedConversations: '200 conversaciones de IA por mes',
    enterpriseConversations: 'Conversaciones de IA personalizables por día',
    basicAiTips: '10 Consejos de IA por mes',
    proAiTips: '25 Consejos de IA por mes',
    unlimitedAiTips: '50 Consejos de IA por mes',
    enterpriseAiTips: 'Límite de Consejos de IA personalizable',
    basicFeatures: 'Escenarios de ventas básicos',
    ...
    faqQuestion7: '¿Qué idiomas soporta SalesBuddy?',
    faqAnswer7: 'SalesBuddy actualmente soporta inglés, estonio, español y ruso. Planeamos agregar más idiomas en el futuro basado en la demanda de los usuarios.',
    faqQuestion8: '¿Qué tan precisa es la retroalimentación de IA?',
    faqAnswer8: 'Nuestra IA proporciona retroalimentación altamente precisa basada en metodologías de ventas probadas. El sistema evalúa tu rendimiento en etapas clave de ventas y proporciona insights accionables para ayudarte a mejorar.',
    faqQuestion9: '¿Puedo exportar mis datos de conversación?',
    faqAnswer9: 'Sí, los usuarios pueden exportar su historial de conversaciones y análisis de rendimiento. Esta función está disponible en todos los planes pagos y te ayuda a rastrear tu progreso a lo largo del tiempo.',
    faqQuestion10: '¿Mis datos están seguros y son privados?',
    faqAnswer10: 'Absolutamente. Utilizamos medidas de seguridad de nivel empresarial para proteger tus datos. Todas las conversaciones están encriptadas en tránsito y en reposo, y nunca compartimos tu información personal con terceros.',
    faqQuestion11: '¿Qué pasa si cancelo mi suscripción?',
    faqAnswer11: 'Puedes continuar usando tu cuenta hasta el final de tu período de facturación actual. Después de la cancelación, perderás acceso a las funciones premium pero puedes reactivar en cualquier momento.',
    faqQuestion12: '¿Ofrecen descuentos por volumen para equipos grandes?',
    faqAnswer12: 'Sí, ofrecemos precios personalizados para equipos empresariales con 50+ usuarios. Contacta a nuestro equipo de ventas en RevoTechSB@gmail.com para discutir descuentos por volumen y funciones personalizadas.',
  ...
  ru: {
    ...
    forgotPasswordSubtitle: 'Не волнуйтесь, мы отправим вам инструкции по сбросу.',
    sendResetInstructions: 'Отправить инструкции по сбросу',
    sending: 'Отправка...',
    checkYourEmail: 'Проверьте вашу электронную почту',
    backToLogin: 'Вернуться к входу',
    rememberPassword: 'Помните пароль? Войти',
    ...
    callModeActive: 'Режим Звонка Активен',
    callModeDescription: 'Голосовой ввод и режим без рук будут автоматически включены. Вы можете говорить естественно с AI клиентом как в реальном телефонном звонке.',
    ...
    basicPlan: 'Базовый',
    proPlan: 'Про',
    unlimitedPlan: 'Безлимитный',
    enterprisePlan: 'Предприятие',
    mostPopular: 'Самый Популярный',
    custom: 'Индивидуальный',
    customizableLimit: 'Настраиваемый лимит',
    unlimitedConversations: 'Безлимитные разговоры',
    conversationsPerMonth: 'разговоров/месяц',
    aiTipsPerMonth: 'ИИ советов в месяц',
    voiceConversationsAndCalls: 'Голосовые разговоры и звонки',
    prioritySupport: 'Приоритетная поддержка',
    advancedTeamManagement: 'Продвинутое управление командами',
    companyLeaderboards: 'Таблицы лидеров компании',
    ssoIntegration: 'SSO интеграция',
    customBranding: 'Индивидуальный брендинг',
    advancedAnalyticsDashboard: 'Продвинутая аналитическая панель',
    apiAccess: 'Доступ к API',
    dedicatedAccountManager: 'Выделенный менеджер аккаунта',
    priorityPhoneSupport: 'Приоритетная телефонная поддержка',
    customTrainingPrograms: 'Индивидуальные программы обучения',
    whiteLabelSolutions: 'Белые решения',
    ...
    // Pricing Features
    freeConversations: '3 ИИ разговора в месяц',
    basicConversations: '30 ИИ разговоров в месяц',
    proConversations: '50 ИИ разговоров в месяц',
    unlimitedConversations: '200 ИИ разговоров в месяц',
    enterpriseConversations: 'Настраиваемые ИИ разговоры в день',
    basicAiTips: '10 ИИ советов в месяц',
    proAiTips: '25 ИИ советов в месяц',
    unlimitedAiTips: '50 ИИ советов в месяц',
    enterpriseAiTips: 'Настраиваемый лимит ИИ советов',
    basicFeatures: 'Базовые сценарии продаж',
    ...
    faqQuestion7: 'Какие языки поддерживает SalesBuddy?',
    faqAnswer7: 'SalesBuddy в настоящее время поддерживает английский, эстонский, испанский и русский языки. Мы планируем добавить больше языков в будущем на основе спроса пользователей.',
    faqQuestion8: 'Насколько точна обратная связь ИИ?',
    faqAnswer8: 'Наш ИИ обеспечивает высокоточную обратную связь, основанную на проверенных методологиях продаж. Система оценивает вашу производительность на ключевых этапах продаж и предоставляет действенные инсайты для улучшения.',
    faqQuestion9: 'Могу ли я экспортировать данные разговоров?',
    faqAnswer9: 'Да, пользователи могут экспортировать историю разговоров и аналитику производительности. Эта функция доступна во всех платных планах и помогает отслеживать прогресс со временем.',
    faqQuestion10: 'Безопасны ли мои данные и конфиденциальны?',
    faqAnswer10: 'Абсолютно. Мы используем корпоративные меры безопасности для защиты ваших данных. Все разговоры зашифрованы при передаче и хранении, и мы никогда не передаем вашу личную информацию третьим лицам.',
    faqQuestion11: 'Что происходит, если я отменю подписку?',
    faqAnswer11: 'Вы можете продолжать использовать свой аккаунт до конца текущего расчетного периода. После отмены вы потеряете доступ к премиум-функциям, но можете реактивировать их в любое время.',
    faqQuestion12: 'Предлагаете ли вы скидки за объем для больших команд?',
    faqAnswer12: 'Да, мы предлагаем индивидуальные цены для корпоративных команд с 50+ пользователями. Свяжитесь с нашей командой продаж по адресу RevoTechSB@gmail.com для обсуждения скидок за объем и индивидуальных функций.',
