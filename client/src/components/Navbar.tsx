        ...
        <div className="mt-3 rounded-xl border border-gray-200 bg-white/80 backdrop-blur shadow-sm">
          <div className="h-14 px-3 md:px-4 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-3">
              <Link to="/pricing" className="btn-primary px-5 py-2.5">Get Started</Link>
            </div>
          ...
          {open && (
            <div className="md:hidden border-t border-gray-200 px-3 py-3">
              <div className="flex flex-col gap-1">
                <NavLink to="/" className={navLinkClasses} onClick={() => setOpen(false)}>Home</NavLink>
                <NavLink to="/pricing" className={navLinkClasses} onClick={() => setOpen(false)}>Pricing</NavLink>
                <NavLink to="/login" className={navLinkClasses} onClick={() => setOpen(false)}>Login</NavLink>
