...
const staticTranslations = {
  ...
  // French
  fr: {
    'betaFeedback': 'Commentaires Bêta',
    'helpUsImproveFeedback': 'Aidez-nous à nous améliorer en signalant des bugs ou des problèmes',
    'whatTypeOfFeedback': 'Quel type de commentaires est-ce ?',
    ...
    'high': 'Élevé',
    'title': 'Titre',
    'titlePlaceholder': 'Brève description du problème (ex: "Le bouton de connexion ne fonctionne pas")',
    'description': 'Description',
    'descriptionPlaceholder': 'Veuillez fournir des informations détaillées sur le problème, les étapes pour le reproduire et tous les messages d\'erreur que vous avez vus.',
    'systemInformationAutoIncluded': 'Informations Système (incluses automatiquement)',
    'url': 'URL',
    'browser': 'Navigateur',
    ...
    'reportBugOrIssue': 'Signaler un Bug ou Problème',
    'thankYou': 'Merci',
    'feedbackSubmittedSuccessfully': 'Vos commentaires ont été soumis avec succès. Nous les examinerons bientôt et vous contacterons si nécessaire.',
    'close': 'Fermer',
    'pleaseEnterTitle': 'Veuillez entrer un titre pour vos commentaires.',
    'pleaseEnterDescription': 'Veuillez entrer une description pour vos commentaires.'
  },
  
  // German
  de: {
    'betaFeedback': 'Beta Feedback',
    'helpUsImproveFeedback': 'Helfen Sie uns zu verbessern, indem Sie Fehler oder Probleme melden',
    'whatTypeOfFeedback': 'Welche Art von Feedback ist das?',
    ...
    'high': 'Hoch',
    'title': 'Titel',
    'titlePlaceholder': 'Kurze Beschreibung des Problems (z.B. "Anmeldebutton funktioniert nicht")',
    'description': 'Beschreibung',
    'descriptionPlaceholder': 'Bitte geben Sie detaillierte Informationen zum Problem, Schritte zur Reproduktion und alle Fehlermeldungen an, die Sie gesehen haben.',
    'systemInformationAutoIncluded': 'Systeminformationen (automatisch eingeschlossen)',
    'url': 'URL',
    'browser': 'Browser',
    ...
    'submitting': 'Sende...',
    'reportBugOrIssue': 'Fehler oder Problem Melden',
    'thankYou': 'Danke',
    'feedbackSubmittedSuccessfully': 'Ihr Feedback wurde erfolgreich übermittelt. Wir werden es bald überprüfen und uns bei Bedarf mit Ihnen in Verbindung setzen.',
    'close': 'Schließen',
    'pleaseEnterTitle': 'Bitte geben Sie einen Titel für Ihr Feedback ein.',
    'pleaseEnterDescription': 'Bitte geben Sie eine Beschreibung für Ihr Feedback ein.'
  },
  
  // Italian
  it: {
    'betaFeedback': 'Feedback Beta',
    'helpUsImproveFeedback': 'Aiutaci a migliorare segnalando bug o problemi',
    'whatTypeOfFeedback': 'Che tipo di feedback è questo?',
    ...
    'high': 'Alto',
    'title': 'Titolo',
    'titlePlaceholder': 'Breve descrizione del problema (es: "Il pulsante di accesso non funziona")',
    'description': 'Descrizione',
    'descriptionPlaceholder': 'Si prega di fornire informazioni dettagliate sul problema, passaggi per riprodurlo e eventuali messaggi di errore visualizzati.',
    'systemInformationAutoIncluded': 'Informazioni di Sistema (incluse automaticamente)',
    'url': 'URL',
    'browser': 'Browser',
    'timestamp': 'Timestamp',
    'user': 'Utente',
    ...
    'reportBugOrIssue': 'Segnala Bug o Problema',
    'thankYou': 'Grazie',
    'feedbackSubmittedSuccessfully': 'Il tuo feedback è stato inviato con successo. Lo esamineremo presto e ti contatteremo se necessario.',
    'close': 'Chiudi',
    'pleaseEnterTitle': 'Si prega di inserire un titolo per il tuo feedback.',
    'pleaseEnterDescription': 'Si prega di inserire una descrizione per il tuo feedback.'
  },
  
  // Portuguese
  pt: {
    'betaFeedback': 'Feedback Beta',
    'helpUsImproveFeedback': 'Ajude-nos a melhorar reportando bugs ou problemas',
    'whatTypeOfFeedback': 'Que tipo de feedback é este?',
    ...
    'high': 'Alto',
    'title': 'Título',
    'titlePlaceholder': 'Breve descrição do problema (ex: "Botão de login não funciona")',
    'description': 'Descrição',
    'descriptionPlaceholder': 'Por favor, forneça informações detalhadas sobre o problema, passos para reproduzir e quaisquer mensagens de erro que você viu.',
    'systemInformationAutoIncluded': 'Informações do Sistema (incluídas automaticamente)',
    'url': 'URL',
    'browser': 'Navegador',
    'timestamp': 'Timestamp',
    'user': 'Usuário',
    ...
    'submitting': 'Enviando...',
    'reportBugOrIssue': 'Reportar Bug ou Problema',
    'thankYou': 'Obrigado',
    'feedbackSubmittedSuccessfully': 'Seu feedback foi enviado com sucesso. Vamos revisá-lo em breve e entrar em contato se necessário.',
    'close': 'Fechar',
    'pleaseEnterTitle': 'Por favor, insira um título para seu feedback.',
    'pleaseEnterDescription': 'Por favor, insira uma descrição para seu feedback.'
  }
};
